...
def _top_n_multi_leg(G, legs, weight_attr, target_value, top_n):
    ...
    if L == 2:
        return _top_n_two_legs(G, legs, weight_attr, target_value, top_n, min_metrics, t_j_caps)
    else:
        return _top_n_three_plus_legs(G, legs, weight_attr, target_value, top_n, t_j_caps)


def _top_n_two_legs(G, legs, weight_attr, target_value, top_n, min_metrics, t_j_caps):
...
def _top_n_three_plus_legs(G, legs, weight_attr, target_value, top_n, t_j_caps):
